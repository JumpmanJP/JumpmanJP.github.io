...
<div className="projects-grid">
        {/* Project 2  */}
        <Card shadow={6} style={{minWidth: '450', margin: 'auto'}}>
            <CardTitle style={{color: 'black', height: '176px', background: 'url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTw-gIwyDY85MHYGRo2Di-TQgraQB1ekmUtaOhZSJ9bM1aEbNr5&s) center / cover ' }} >Angular Project #1</CardTitle>
            <CardText>
...
<div className="projects-grid">
        {/* Project 3  */}
        <Card shadow={6} style={{minWidth: '450', margin: 'auto'}}>
            <CardTitle style={{color: 'black', height: '176px'  }} >API Project #1</CardTitle>
            <CardText>
